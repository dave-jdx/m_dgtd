...
from UI.ui_frmThermalRadiation import Ui_frmThermalRadiation
from ..icons import sysIcons
from .frmBase import frmBase


class frmThermalRadiation(Ui_frmThermalRadiation,frmBase):
    sigMidiaModify=QtCore.pyqtSignal(tuple)
  
    def __init__(self,parent=None):
        super(frmThermalRadiation,self).__init__(parent)
