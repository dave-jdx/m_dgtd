...
from UI.ui_frmCircuitCreate import Ui_frmCIrcuitCreate
from ..icons import sysIcons
from .baseStyle import baseStyle

class frmCircuitCreate(Ui_frmCIrcuitCreate,QtWidgets.QMainWindow):
    sigMidiaModify=QtCore.pyqtSignal(tuple)
  
    def __init__(self,parent=None):
        super(frmCircuitCreate,self).__init__(parent)
