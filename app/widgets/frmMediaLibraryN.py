...
class frmMediaLibraryN(Ui_frmMediaLIbraryN,QtWidgets.QMainWindow):
    ...
    def fillRow_isotropic(self,isotropic:Isotropic,rowIndex):
        ...
        item=QTableWidgetItem(isotropic.s_e_lifetime)
        self.tbIsotropic.setItem(rowIndex, 10, item)
        item=QTableWidgetItem(isotropic.s_h_lifetime)
        self.tbIsotropic.setItem(rowIndex, 11, item)
        item=QTableWidgetItem(isotropic.s_bandgap)
        self.tbIsotropic.setItem(rowIndex, 12, item)
        item=QTableWidgetItem(isotropic.s_e_affinity)
        self.tbIsotropic.setItem(rowIndex, 13, item)
        item=QTableWidgetItem(isotropic.s_e_v_band)
        self.tbIsotropic.setItem(rowIndex, 14, item)
        item=QTableWidgetItem(isotropic.s_e_c_band)
        self.tbIsotropic.setItem(rowIndex, 15, item)
        item=QTableWidgetItem(isotropic.s_e_mobility)
        self.tbIsotropic.setItem(rowIndex, 16, item)
        item=QTableWidgetItem(isotropic.s_h_mobility)
        self.tbIsotropic.setItem(rowIndex, 17, item)
        item = QTableWidgetItem(isotropic.owner)
        self.tbIsotropic.setItem(rowIndex, 18, item)
