...
class CTitleBar(QWidget):
    ...
    def mousePressEvent(self, event):
        ...
        if event.button() == Qt.LeftButton:
            self.mPos = event.pos()
            self._root.offset = event.globalPos() - self.frameGeometry().bottomRight()
    ...
    def setupUi(self):
        ...
        self.setMaximumSize(SCREEN_WIDTH, self.Radius)
        ...
        self.lblIcon.setPixmap(sysIcons.windowIcon.pixmap(30,30))
        ...
        for name, text in (('buttonMinimum', '0'), ('buttonMaximum', '1'),
            ...
            # button.setStyleSheet("color:rgb(178,178,178);background-color:rgb(74,74,76)")
