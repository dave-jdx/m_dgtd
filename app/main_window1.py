...
class MainWindow(QMainWindow, MainMixin):
    ...
    def __init__(self, parent=None, spid=None,projectFile:str=""):
        ...
        self.tabWidget.addTab(self.meshViewer, "天线方向图")
    ...
    def add_tab_postprocess(self):
        ...
        # self.add_ribbon_button(pane_animate,menuPool.post_animate_play,menuIcons.post_ani_play).clicked.connect(self.noneAction)
        # self.add_ribbon_button(pane_animate,menuPool.post_animate_stop,menuIcons.post_ani_stop).clicked.connect(self.noneAction)
        # self.add_ribbon_button(pane_animate,menuPool.post_animate_faster,menuIcons.post_ani_faster).clicked.connect(self.noneAction)
        # self.add_ribbon_button(pane_animate,menuPool.post_animate_slower,menuIcons.post_ani_slower).clicked.connect(self.noneAction)
        # self.add_ribbon_button(pane_animate,menuPool.post_animate_type,menuIcons.post_ani_type).clicked.connect(self.noneAction)
        # self.add_ribbon_button(pane_animate,menuPool.post_animate_settings,menuIcons.post_ani_settings).clicked.connect(self.noneAction)

        # self.cbxFreq2=RibbonComboBox(self)
        # self.cbxSurface2=RibbonComboBox(self)
        # self.cbxPosition2=RibbonComboBox(self)
        # self.lblPosition2=QLabel(menuPool.lblPosition)
        # self.lblSurface2=QLabel(menuPool.lblSurface)
        # self.cbxSurface2.setDisabled(True)
        # self.cbxPosition2.setDisabled(True)
        # self.lblSurface2.setDisabled(True)
        # self.lblPosition2.setDisabled(True)
        # self.cbx_grid2 = pane_filter.add_grid_widget(300*gui_scale())
        # self.cbx_grid2.addWidget(QLabel(menuPool.lblFrequency), 1, 1)
        # self.cbx_grid2.addWidget(self.lblSurface2, 2, 1)
        # self.cbx_grid2.addWidget(self.lblPosition2, 3, 1)
        # self.cbx_grid2.addWidget(self.cbxFreq2, 1, 2)
        # self.cbx_grid2.addWidget(self.cbxSurface2, 2, 2)
        # self.cbx_grid2.addWidget(self.cbxPosition2, 3, 2)

        # self.cbxFreq2.currentIndexChanged.connect(self.projectTree.freqChanged)
        # self.cbxSurface2.currentIndexChanged.connect(self.projectTree.surfaceChanged)
        # self.cbxPosition2.currentIndexChanged.connect(self.projectTree.positionChanged)
    ...
    def sig_mpiSet(self,mpiNum,installPath):
        Project.mpi["value"]=mpiNum
        Project.mpiInstallPath=installPath
    def setMPI(self):
        mpiNum=Project.mpi["value"]
    ...
    def pickEdge(self):
        '''拾取边 创建port用
        '''
        # self.selectContext.initShape(self.projectTree.currentModel.shapeList)
    ...
    def showContextMenu(self, pos):
        ...
        if(self.projectTree.currentModel!=None and any(self.projectTree.currentModel.face_selected.values())):
            ...
            actions=[QAction("本体材料",self,enabled=True,
